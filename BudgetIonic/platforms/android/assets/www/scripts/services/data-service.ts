...
module Budget {
    ...
    export class DataService implements IDataService {
        ...
        constructor(private $q: ng.IQService, $firebaseArray: AngularFireArrayService, private aggregatorService: AggregatorService) {
        ...
        private ensureData() {
            this._accountsReference
                ...
                .once(
                    ...
                    snapshot => {
                        if (!snapshot.val()) {
                            this.createDemoData().then(x => this.ensureData());
                        }
                    });
        }
